  ...
  return (
    <header className={`fixed w-full top-0 z-50 ${scrolled ? 'bg-black/60 backdrop-blur-md border-b border-white/20' : ''}`}>
      <div className="container flex items-center justify-between py-4">
        ...
        <div className="hidden md:flex items-center gap-3 text-sm" aria-label="Socials">
          <a href="https://instagram.com/luvra.iq" target="_blank" rel="noreferrer" className="hover:underline hover:!opacity-100">Instagram</a>
          <a href="https://www.tiktok.com/@luvra.iq" target="_blank" rel="noreferrer" className="hover:underline hover:!opacity-100">TikTok</a>
        </div>
